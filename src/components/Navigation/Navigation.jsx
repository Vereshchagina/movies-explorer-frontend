      ...
      {!isLogged ? (
        <div className="navigation">
          <nav className="navigation__links">
            <Link
              className={`navigation__link navigation__link_reg link ${
          ...
          <button
            className="navigation__burger-btn button"
            type="button"
            onClick={openMenu}
          />
        </div>
        ...
        <div className="navigation">
          <Link
            className="navigation__link navigation__link_unreg link"
            to="/signup"
          >
            Регистрация
          </Link>
          <Link to="/signin">
            <button className="navigation__button button" type="button">
              Войти
            </button>
          </Link>
        </div>
