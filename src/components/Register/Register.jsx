    ...
    return (
        <section className="register">
            ...
            <form className="register__form">
                ...
                <button className="register__button-submit button" type="submit" aria-label="Зарегистрироваться.">Зарегистрироваться</button>

                <div className="register__actions">
                    <p className="register__text">Уже зарегистрированы?</p>
                    <Link className="register__login link link_blue" to="/signin">Войти</Link>
                </div>
